...
namespace EduHome.UI.Migrations
{
    ...
    [Migration("20230703072614_CreateBlogDetailTable")]
    partial class CreateBlogDetailTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EduHome.Core.Entities.BlogDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EduHome.Core.Entities.NoticeRight", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EduHome.Core.Entities.BlogDetail", b =>
                {
                    b.HasOne("EduHome.Core.Entities.Blog", "Blog")
                        .WithOne("BlogDetailId")
                        .HasForeignKey("EduHome.Core.Entities.BlogDetail", "BlogId")
            ...
            modelBuilder.Entity("EduHome.Core.Entities.Speaker", b =>
                {
                    b.HasOne("EduHome.Core.Entities.EventDetail", "EventDetail")
                        .WithMany("Speakers")
            ...
            modelBuilder.Entity("EduHome.Core.Entities.Blog", b =>
                {
                    b.Navigation("BlogDetailId")
                        .IsRequired();
                });

            modelBuilder.Entity("EduHome.Core.Entities.Course", b =>
                {
                    b.Navigation("CourseDetailId")
                        .IsRequired();
                });

            modelBuilder.Entity("EduHome.Core.Entities.Event", b =>
                {
                    b.Navigation("EventDetailId")
                        .IsRequired();
                });
